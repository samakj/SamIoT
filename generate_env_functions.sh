...
CHICKEN_COOP_IP_LOCATION=$AQUAPONICS_IP_LOCATION
CHICKEN_COOP_HOSTNAME=$AQUAPONICS_HOSTNAME
CHICKEN_COOP_LOCATION=$AQUAPONICS_LOCATION
CHICKEN_COOP_OTA_PASS=$AQUAPONICS_OTA_PASS
EOF
    cp "$devices/.env" "$devices/env.sh"
    clean_env
}
