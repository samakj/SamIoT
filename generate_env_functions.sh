...
CHICKEN_COOP_IP_LOCATION=$CHICKEN_COOP_IP_LOCATION
CHICKEN_COOP_HOSTNAME=$CHICKEN_COOP_HOSTNAME
CHICKEN_COOP_LOCATION=$CHICKEN_COOP_LOCATION
CHICKEN_COOP_OTA_PASS=$CHICKEN_COOP_OTA_PASS
EOF
    cp "$devices/.env" "$devices/env.sh"
    clean_env
}
