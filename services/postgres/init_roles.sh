...
psql --port=$DB_PORT --username=$POSTGRES_USER --command="CREATE USER $UTILITIES_DB_USER WITH PASSWORD '$UTILITIES_PASS';"
...
psql --port=$DB_PORT --username=$POSTGRES_USER --command="CREATE USER $WEATHER_DB_USER WITH PASSWORD '$WEATHER_PASS';"
