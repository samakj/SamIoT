...
init_api () {
    ...
    export PORTAINER_CONTAINER_NAME=$PORTAINER_CONTAINER_NAME

    envsubst '${NGINX_PORT}:${PORTAINER_CONTAINER_NAME}:${PORTAINER_PORT}:${IOT_API_CONTAINER_NAME}:${IOT_API_PORT}:${UTILITIES_API_CONTAINER_NAME}:${UTILITIES_API_PORT}:${WEATHER_API_CONTAINER_NAME}:${WEATHER_API_PORT}' \
        < "$nginx/api.template" \
        > "$nginx/api.conf"
...
init_scrapers () {
    ...
    envsubst '${NGINX_PORT}:${PORTAINER_CONTAINER_NAME}:${PORTAINER_PORT}:${IOT_FORAGER_CONTAINER_NAME}:${IOT_FORAGER_PORT}:${UTILITIES_SCRAPER_CONTAINER_NAME}:${UTILITIES_SCRAPER_PORT}:${WEATHER_SCRAPER_CONTAINER_NAME}:${WEATHER_SCRAPER_PORT}' \
...
init_managers () {
    ...
    envsubst '${NGINX_PORT}:${PORTAINER_CONTAINER_NAME}:${PORTAINER_PORT}:${SOLAR_MANAGER_CONTAINER_NAME}:${SOLAR_MANAGER_PORT}' \
...
init_frontend () {
    ...
    envsubst '${NGINX_PORT}:${PORTAINER_CONTAINER_NAME}:${PORTAINER_PORT}:${FRONTEND_CONTAINER_NAME}:${FRONTEND_PORT}' \
