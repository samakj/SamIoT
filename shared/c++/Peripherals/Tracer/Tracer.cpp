...
SamIoT::Peripherals::Tracer::Tracer(
...
void SamIoT::Peripherals::Tracer::setBatteryChargingCurrentCallback(
...
void SamIoT::Peripherals::Tracer::setBatteryChargingPowerCallback(
...
void SamIoT::Peripherals::Tracer::setSystemVoltageCallback(
    SystemVoltageCallback _systemVoltageCallback)
{
    this->systemVoltageCallback = _systemVoltageCallback;
};

void SamIoT::Peripherals::Tracer::setup(void (*preTransmission)(), void (*postTransmission)())
{
...
void SamIoT::Peripherals::Tracer::loop()
{
    if (!this->client)
        this->setup();
    if (
...
boolean SamIoT::Peripherals::Tracer::getCoil(uint16_t address, boolean defaultValue)
{
...
float SamIoT::Peripherals::Tracer::get8BitRegister(uint16_t address, float multiplier, float defaultValue)
{
...
float SamIoT::Peripherals::Tracer::get16BitRegister(uint16_t address, float multiplier, float defaultValue)
{
...
void SamIoT::Peripherals::Tracer::checkPVVoltage()
{
...
void SamIoT::Peripherals::Tracer::checkPVCurrent()
{
...
void SamIoT::Peripherals::Tracer::checkPVPower()
{
...
void SamIoT::Peripherals::Tracer::checkBatteryChargingVoltage()
{
...
void SamIoT::Peripherals::Tracer::checkBatteryChargingCurrent()
{
...
void SamIoT::Peripherals::Tracer::checkBatteryChargingPower()
{
...
void SamIoT::Peripherals::Tracer::checkLoadVoltage()
{
...
void SamIoT::Peripherals::Tracer::checkLoadCurrent()
{
...
void SamIoT::Peripherals::Tracer::checkLoadPower()
{
...
void SamIoT::Peripherals::Tracer::checkBatteryTemperature()
{
...
void SamIoT::Peripherals::Tracer::checkCaseTemperature()
{
...
void SamIoT::Peripherals::Tracer::checkHeatSinkTemperature()
{
...
void SamIoT::Peripherals::Tracer::checkBatteryPercentage()
{
...
void SamIoT::Peripherals::Tracer::checkRemoteBatteryTemperature()
{
...
void SamIoT::Peripherals::Tracer::checkSystemVoltage()
{
