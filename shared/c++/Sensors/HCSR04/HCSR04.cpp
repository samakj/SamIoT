...
void SamIoT::Sensors::HCSR04::setDistanceCallback(
    DistanceCallback _distanceCallback)
{
    this->distanceCallback = _distanceCallback;
};

void SamIoT::Sensors::HCSR04::setTemperature(float _temperature)
{
    this->temperature = _temperature;
}

float SamIoT::Sensors::HCSR04::getSpeedOfSound()
{
    return 331.3 + 0.606 * this->temperature;
}

void SamIoT::Sensors::HCSR04::setup()
{
...
void SamIoT::Sensors::HCSR04::loop()
{
...
void SamIoT::Sensors::HCSR04::check()
{
...
void SamIoT::Sensors::HCSR04::trigger()
{
    pinMode(this->triggerPin, OUTPUT);
...
float SamIoT::Sensors::HCSR04::getEchoTime()
{
    pinMode(this->echoPin, INPUT);
    return pulseIn(this->echoPin, HIGH, 50000) / 1000000.0f;
}

float SamIoT::Sensors::HCSR04::getDistance()
{
    this->trigger();
...
float SamIoT::Sensors::HCSR04::getMedianDistance(uint8_t noTests)
{
