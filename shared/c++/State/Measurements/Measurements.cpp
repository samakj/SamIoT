...
std::string SamIoT::State::Measurements::getKey(std::string metric, std::vector<std::string> tags)
{
    std::string key = "";
...
void SamIoT::State::Measurements::remove(std::string metric, std::vector<std::string> tags)
{
...
void *SamIoT::State::Measurements::get(std::string metric, std::vector<std::string> tags)
{
    std::string key = SamIoT::State::Measurements::getKey(metric, tags);
...
void SamIoT::State::Measurements::set(
    std::nullptr_t value,
    std::string metric,
...
std::string SamIoT::State::Measurements::serialise(std::string additionalProps)
{
    std::string output = "[";
    uint8_t len = 0;
...
std::vector<std::string> SamIoT::State::Measurements::serialiseToArray(std::string additionalProps)
{
...
std::string SamIoT::State::Measurements::serialiseKey(std::string key)
{
    std::string output = "";
...
std::string SamIoT::State::Measurements::serialiseKey(std::string metric, std::vector<std::string> tags)
{
    std::string output = "";
...
std::string SamIoT::State::Measurements::serialiseNull(
    std::nullptr_t value,
    std::string key,
...
std::string SamIoT::State::Measurements::serialiseBool(
    bool value,
    std::string key,
    std::string additionalProps)
{
...
std::string SamIoT::State::Measurements::serialiseInt(
    int value,
    std::string key,
    std::string additionalProps)
{
...
std::string SamIoT::State::Measurements::serialiseFloat(
    float value,
    std::string key,
    std::string additionalProps)
{
...
std::string SamIoT::State::Measurements::serialiseString(
    std::string value,
    std::string key,
    std::string additionalProps)
{
